...
namespace DapperExtensions.Test.IntegrationTests.Async.MySql
{
    ...
    public static class CrudFixture
    {
        ...
        [TestFixture]
        public class GetListMethod : MySqlBaseAsyncFixture
        {
        ...
        [TestFixture]
        public class GetPageMethod : MySqlBaseAsyncFixture
        {
        ...
        [TestFixture]
        public class CountMethod : MySqlBaseAsyncFixture
        {
            private void Arrange()
            {
        ...
        [TestFixture]
        public class GetMultipleMethod : MySqlBaseAsyncFixture
        {
            [Test]
